programa
{
	...
	inteiro xcabeca_cobra=275,ycabeca_cobra=275
	...
	inteiro xcomida=300,ycomida=300

	inteiro tamanho_cobra=2

	inteiro xcauda_cobra[600],ycauda_cobra[600]
	...
	funcao desenhar_painel(){
		...
		g.desenhar_texto(10, 15, "Pontuação atual: " + pontuacao)
		g.definir_cor(g.COR_VERMELHO)
		g.definir_tamanho_texto(20.0)
		g.desenhar_texto(510, 20, "Morte: " + morte)
	}
	...
	funcao logico cobra_bateu_parede(){
		...
		senao se(ycabeca_cobra > 575 ou ycabeca_cobra < 0){
			retorne verdadeiro
		}
		senao{
			retorne falso
